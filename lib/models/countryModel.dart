...
//
//     final countrySlip = countrySlipFromJson(jsonString);

import 'dart:convert';

List<CountrySlip> countrySlipFromJson(String str) => List<CountrySlip>.from(json.decode(str).map((x) => CountrySlip.fromJson(x)));

String countrySlipToJson(List<CountrySlip> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CountrySlip {
    ...
    factory CountrySlip.fromJson(Map<String, dynamic> json) => CountrySlip(
        name: json["name"],
